...
自動実行内容:
- Assignee: @n-takatsu 自動割り当て <!-- cSpell:ignore takatsu -->
- 緊急対応コメント自動追加
- エスカレーション手順通知
```
...
gh project item-add 1 --owner n-takatsu --url "https://github.com/n-takatsu/mcp-rs/issues/XX" # cSpell:ignore takatsu
```
