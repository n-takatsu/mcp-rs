...
const SITE_TITLE: &str = "RedRing 公式サイト";
...
const FRONT_PAGE_TITLE: &str = "RedRing 公式サイト";
    ...
    <section class="rr-hero">
      <div class="rr-hero-main">
        ...
        <h1 class="rr-title">CAD設計を、正確に、速く、再利用しやすく。</h1>
            <p class="rr-sub">RedRing公式サイトは、CAD作業の手戻りを減らし、設計を再利用しやすくすることを目指しています。実務で使える改善を積み重ね、継続的に品質と運用性を高めます。</p>
